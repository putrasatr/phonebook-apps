    ...
    for (i = 1; i <= pages; i++) {
      page.push(
        <li
          ...
          key={i}
        >
          <button className="page-link" onClick={this.handlePage} id={i}>
            {i}
          </button>
        </li>
      );
      ...
      <div>
              ...
              <div className="row">
                ...
                <div className="col-md-6">
                  <div className="col-sm-11 d-flex">
                    <label className="col-form-label md-4 mr-2">
                      <b>Phone</b>
                    </label>
                    <input
                      type="text"
        ...
        <nav aria-label="Page navigation example position-sticky">
          <ul className="pagination">
            ...
            <li
              className={` ${
                this.state.currentPage === page.length
                  ? "page-item disabled"
                  : "page-item"
              }`}
            >
...
const mapDispatchToProps = (dispatch) => ({
  loadContact: (curpage, limit, searchName, searchPhone) =>
    dispatch(loadContact(curpage, limit, searchName, searchPhone)),
});
